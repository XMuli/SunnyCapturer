...
void ConfigManager::readFromFile()
{
    ...
    GET_VALUE_PROPERTY(XGeneral_auto_detect_windows)     = READ_INI(XInterface, XGeneral_auto_detect_windows, true).toBool();
    GET_VALUE_PROPERTY(XGeneral_auto_copy_to_clipbaoard) = READ_INI(XInterface, XGeneral_auto_copy_to_clipbaoard, true).toBool();
    GET_VALUE_PROPERTY(XGeneral_crosshair_show)          = READ_INI(XInterface, XGeneral_crosshair_show, false).toBool();
    // Output
    ...
    qDebug() << GET_VALUE_PROPERTY(XInterface_style) << GET_VALUE_PROPERTY(XInterface_highlight) << GET_VALUE_PROPERTY(XInterface_border_width) << GET_VALUE_PROPERTY(XInterface_crosshair) << GET_VALUE_PROPERTY(XInterface_crosshair_width)
             << GET_VALUE_PROPERTY(XGeneral_auto_detect_windows) << GET_VALUE_PROPERTY(XGeneral_auto_copy_to_clipbaoard) << GET_VALUE_PROPERTY(XGeneral_crosshair_show);
